...
class CostFragment : Fragment(), CostAdapter.OnDescriptionClickListener {
    ...
    setHasOptionsMenu(true)
        ...
        val categories = resources.getStringArray(R.array.category_cost) // Замените на реальные категории
    ...
    private fun applyFilters() {
        ...
        val dateFrom = binding.drawerFilterCost.dateFromEditText.text.toString().takeIf { it.isNotEmpty() }
        val dateTo = binding.drawerFilterCost.dateToEditText.text.toString().takeIf { it.isNotEmpty() }
    ...
    private fun getIntentFromMainAct(cost: AddCost) {
        ...
        dbManager.getImagesFromDatabase(cost.id!!) {
